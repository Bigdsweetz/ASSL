...
<?php
	...
	$numtoursradio = array( //this is how you can create radio buttons for each object
		'name'	=> 'num_tours',
		'id'	=> 'num_tours',
		'value' => '0',
		'checked' => TRUE,
	...
	$interests = array(  //this is how you can make check boxes
	...
	echo form_submit('submit', 'Join Now!');  //this is the submit button
	
	echo form_close();  // must have this to close the page
